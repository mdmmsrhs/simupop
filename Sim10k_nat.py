...
def sampleAndExport(pop):
    ...
    export(sample, format='fstat', output='sim10k_nat_a_000000_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_040000_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_001400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_000034_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_041400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_041434_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_040034_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_140400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_340004_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_341404_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_nat_a_043414_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_000000_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_040000_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_001400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_000034_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_041400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_041434_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_040034_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_140400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_340004_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_341404_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_a_043414_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_040000_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_001400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
simu.evolve(
	...
	preOps=[
		sim.SNPMutator(u = u, v = v),
		sim.Migrator(rate=migrIslandRates(m, n)),
# 		sim.MaPenetrance(loci=0, penetrance=[1, 1, 0.0]),
# 	    sim.DiscardIf(True, subPops=[
#         (x, 'Affected') for x in list(range(n))], at = j1),
        sim.MapSelector(loci=14, fitness = {(0,0):1-s1, (0,1):1-s1, (1,1):1}, begin = j2, end = (j2+d2)),# Positive Selection for allele 1 at locus given
#         sim.MapSelector(loci=34, fitness = {(0,0):1-s1, (0,1):1-s1, (1,1):1}, begin = j3, end = (j3+d3)),# Positive Selection for allele 1 at locus given
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_000034_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
# 		sim.MaPenetrance(loci=0, penetrance=[1, 1, 0.0]),
# 	    sim.DiscardIf(True, subPops=[
#         (x for x in (list(range(n))), 'Affected')], at=[j1]),
#         sim.MapSelector(loci=14, fitness = {(0,0):1-s1, (0,1):1-s1, (1,1):1}, begin = j2, end = (j2+d2)),# Positive Selection for allele 1 at locus given
        sim.MapSelector(loci=34, fitness = {(0,0):1-s1, (0,1):1-s1, (1,1):1}, begin = j3, end = (j3+d3)),# Positive Selection for allele 1 at locus given
    ],
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_041400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_041434_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_040034_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_140400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_340004_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_341404_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10j_a_043414_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
