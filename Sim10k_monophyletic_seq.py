...
# Modified: February 04, 2013 11:39:47 AM    
##
...
def sampleAndExport(pop):
    ...
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_000000_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_030000_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_000700_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_000012_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_030700_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_030712_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_030012_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_070300_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_120003_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_120703_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_nat_a_031207_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_000000_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_030000_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_000700_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_000012_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_030700_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_030712_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_030012_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_070300_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_120003_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_120703_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='phylip', output='sim10k_mono_seq_a_031207_sample_%d.dat' % pop.dvars().gen, alleleNames = ('A','C','G','T'), gui=False),
    return True
...
def sampleAndExport(pop):
    ...
    new_sz = [x//1000 for x in sz]
    sample = drawRandomSample(pop, new_sz)
    export(sample, format='fstat', output='sim10k_mono_nat_a_001400_sample_%d.dat' % pop.dvars().gen, gui = False)
    return True
